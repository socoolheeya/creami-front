...
export declare function TableHeader({ children, className }: TableHeaderProps): import("react/jsx-runtime").JSX.Element;
...
export declare function TableCell({ children, className, align, ...props }: TableCellProps): import("react/jsx-runtime").JSX.Element;
export declare function TableHead({ children, className, align, ...props }: TableHeadProps): import("react/jsx-runtime").JSX.Element;
